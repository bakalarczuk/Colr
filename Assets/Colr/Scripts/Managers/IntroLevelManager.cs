...
namespace Habtic.Games.Colr
{
    public class IntroLevelManager : Singleton<IntroLevelManager>
    {
        ...
        void Awake()
        {
            ...
            _notifications.ManualBlastStop();
        }
        ...
        {
            _notifications.ManualBlastStart();
			_colorWheel.ComeOut();
            ...
            if (correct)
            {
                ...
                _tweenM = LeanTween.scale(_notifications.CorrectIndicator, Vector3.one, 1f)
                    ...
                    .setOnComplete(() =>
                    {
                        ...
                        {
                            _progress.fillAmount += 0.25f;
							LeanTween.scale(_notifications.CorrectIndicator, Vector3.zero, 0.5f)
								.setEase(LeanTweenType.easeInOutSine)
								.setOnComplete(() => {
									StartTutorialTwo();
								});
            ...
            else
            {
                ...
                _tweenM = LeanTween.scale(_notifications.IncorrectIndicator, Vector3.one, 1f)
                    ...
                    .setOnComplete(() =>
                    {
                        ...
                        {
                            _progress.fillAmount += 0.25f;
 							LeanTween.scale(_notifications.IncorrectIndicator, Vector3.zero, 0.5f)
								.setEase(LeanTweenType.easeInOutSine)
								.setOnComplete(() => {
                           			StartTutorialTwo();
								});
